...
route.delete("/eliminar-usuario", hasSession, usuarios_abc.eliminar);
...
route.post("/carrito", hasSession, carritos_abc.guardar); //Ruta para guardar el producto marcado al carrito
route.put("/finalizar_pedido", pedidos_abc.finalizar); //Ruta para finalizar algun pedido
route.delete("/carrito/:producto", hasSession, carritos_abc.eliminar);
